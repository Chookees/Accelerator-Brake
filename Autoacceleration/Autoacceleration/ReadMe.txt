========================================================================
    KONSOLENANWENDUNG: Autoacceleration-Projektübersicht
========================================================================

Diese Autoacceleration-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Autoacceleration-Anwendung besteht.


Autoacceleration.vcxproj
...
Autoacceleration.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Autoacceleration.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
